...
SLASH_COMMANDS: dict[str, str] = {
    ...
    "/copy": "Copy last output to clipboard (pbcopy/clip.exe/xclip/wl-copy)",
...
class HelpScreen(ModalScreen[None]):
    ...
    def _build_help_text(self) -> str:
        lines = [
            ...
            "  clipboard. If clipboard tools are unavailable (pbcopy, clip.exe,",
            "  wl-copy, xclip, xsel), the transcript is auto-exported to ~/.nexus/logs/.",
